  ...
  /*  @Autowired
   private WxMpService wxMpService;
    ...
    public String authorize(@RequestParam("returnUrl")String returnUrl){
        //String redirectURI, String scope, String state参数
        String url="http://tqhsell.natapp1.cc/sell/wechat/userinfo";
    ...
    public String userInfo(@RequestParam("code")String code,
        ...
        try {
            ...
            log.info("【微信网页授权】，{} ",e);
            throw new Sellexception(ResultEnum.WEIXIN_MP_ERROR.getCode(),e.getError().getErrorMsg());
        }
